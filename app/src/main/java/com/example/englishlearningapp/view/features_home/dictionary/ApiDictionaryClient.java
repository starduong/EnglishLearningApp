...
import com.example.englishlearningapp.view.features_home.dictionary.DictionaryApiService;
...
public class ApiDictionaryClient {
    private static final String BASE_URL = "https://api.dictionaryapi.dev/";
    private static Retrofit retrofit = null;

    public static DictionaryApiService getApiService() {
        if (retrofit == null) {
